...
import Tournamentstandingcontent from "../../../summary/Tournamentstandingcontent";

const Tournamentstandingbody = () => {
    return(
...
export default Tournamentstandingbody;